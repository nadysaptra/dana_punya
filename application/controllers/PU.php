...
function __construct()
	...
	if($this->session->userdata('logged_in')){
		...
		$data['title']='Dashbord Admin Laporan PU';
		$data['caption']="<h1>Laporan Berdasarkan Perairan UMUM</h1>";
		...
		$data['produksi']=$this->produksi_model->ambil_data_berdasarkan_pu();
		$this->load->view('includes/header',$data);
		$this->load->view('admin/dashbord',$data);
		$this->load->view('admin/navi_admin',$data);
		$this->load->view('admin/laporan_pu',$data);
...
$this->fpdf->Ln(1);
$this->fpdf->SetFont('Times','B',12);
$this->fpdf->Cell(19,1,'Berdasarkan Sumber Perairan UMUM',0,0,'C');//MEMBUAT HEADER
...
$this->fpdf->Output('laporan_produksiPU.pdf',"I");
