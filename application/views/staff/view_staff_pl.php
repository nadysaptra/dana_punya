...
<div class="panel-header"><?php echo $caption;?></div>
    <ul class="tabs">
        ...
        <li><a href="#_page_2"> Data Nelayan </a></li>
	...
	<ul class="element-menu">  <li class="place-right"><a href="<?php echo base_url();?>PL/view_pdf" target="new"><i class="icon-file-pdf"></i>PDF</a></li>
    ...
    $('#scrollbox3').dataTable();
        ...
        <div class="frame" id="_page_2"><font color="red">Data Nelayan</font></div>
